...
func is_choosing_location():
	return SummoningState.current_state == SummoningState.summoning_states.CHOOSING_LOCATION

func is_choosing_direction():
	return SummoningState.current_state == SummoningState.summoning_states.CHOOSING_DIRECTION
